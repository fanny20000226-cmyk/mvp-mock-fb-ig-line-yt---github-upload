...
const sections = [
  ...
  },
  {
    ...
    title: "6. 施工照片雲端歸檔與查找",
    body: [
      "施工頁與技師現場模式上傳的照片會依客戶、車輛、施工單及施工前後自動歸檔；報價照片在施工單關聯明確後一併整理。",
      "施工照標準路徑為：門市 ID / customers / 客戶 ID / vehicles / 車輛 ID / work-orders / 施工單 ID / before 或 after / 照片。第一層維持門市 UUID，符合既有 Supabase Storage Policy。",
      "管理員可在「系統設定與治理中心 → 備份與還原」先掃描舊照片，再執行照片歸檔。系統只複製並更新正式資料連結，原始檔保留，不會自動刪除。",
      "舊照片只有在能由施工單、報價或唯一車輛工單確認歸屬時才會自動整理；無法確認者列為待人工確認並保留原位，避免誤歸檔。"
    ]
  },
  {
    id: "appointments",
