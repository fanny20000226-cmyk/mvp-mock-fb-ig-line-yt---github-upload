...
begin
  ...
  select c.tenant_id,c.store_id into tenant_uuid,shop_uuid from public.customers c where c.id=customer_uuid;
...
select c.id customer_id,c.tenant_id,c.store_id as shop_id,c.name,c.phone,
